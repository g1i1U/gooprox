...
class HardenedHTTPSConnection(HTTPSConnection):
    ...
    def __init__(self, host, address_family=0, **kwargs):
        HTTPSConnection.__init__(self, host, context=ssl._create_unverified_context(), **kwargs)
        # HTTPSConnection.__init__(self, '127.0.0.1', 9040, cert_file=None, context=ssl._create_unverified_context(), check_hostname=None, **kwargs)
